...
internal static class LibExtism
{
    ...
    /// <returns></returns>
    [DllImport("extism")]
    unsafe public static extern bool extism_plugin_update(IntPtr context, IntPtr plugin, byte* wasm, IntPtr *functions, int nFunctions, int wasmLength, bool withWasi);
