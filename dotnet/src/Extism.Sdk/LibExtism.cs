...
internal static class LibExtism
{
    ...
    /// <returns></returns>
    [DllImport("extism")]
    unsafe internal static extern bool extism_plugin_update(ExtismContext* context, Int32 plugin, byte* wasm, int wasmLength, IntPtr* functions, int nFunctions, bool withWasi);
